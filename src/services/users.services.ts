...
class UsersService {
  ...
  private signEmailVerifyToken({ user_id, verify }: { user_id: string; verify: UserVerifyStatus }) {
    return signToken({
      ...
      options: { expiresIn: process.env.EMAIL_VERIFY_TOKEN_EXPIRES_IN as StringValue }
    })
  }
  ...
  async forgotPassword({ user_id, verify }: { user_id: string; verify: UserVerifyStatus }) {
    ...
    console.log('Mô phỏng việc gửi email cho user link để click reset password', forgot_password_token)
