 ...
 */
usersRouter.post('/verify-email', emailVerifyTokenValidator, wrapRequestHandler(verifyEmailEmailController))
...
/**
 * Description: Forgot password when user client forgot password
